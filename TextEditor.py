...
main_application.title('J-Notes Text editor')
...
monokal_icon=tk.PhotoImage(file='monokai.png')
...
color_icons=(light_default_icon,light_plus_icon,dark_icon,red_icon,monokal_icon,night_blue_icon)
...
font_size['values']=tuple(range(0,100))
...
#italic
iti_icon=tk.PhotoImage(file='italic.png')
iti_btn=ttk.Button(tool_bar,image=iti_icon)
iti_btn.grid(row=0,column=3,padx=5)

#underline
und_icon=tk.PhotoImage(file='underline.png')
und_btn=ttk.Button(tool_bar,image=und_icon)
und_btn.grid(row=0,column=4,padx=5)

#font color
fc_icon=tk.PhotoImage(file='font_color.png')
fc_btn=ttk.Button(tool_bar,image=fc_icon)
fc_btn.grid(row=0,column=5,padx=5)
...
iti_btn.configure(command=change_italic)
...
und_btn.configure(command=change_underline)
...
fc_btn.configure(command=change_font_color)
